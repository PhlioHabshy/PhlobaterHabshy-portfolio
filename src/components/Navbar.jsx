      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <a
              href="#home"
              className="group font-mono text-2xl font-bold transition-all duration-300 transform hover:scale-105 relative"
            >
              <span className="inline-block">
                <span className="group-hover:hidden gradient-text">PAH</span>
                <span className="hidden group-hover:inline-block gradient-text">
                  Phlobater Attef Habshy
                </span>
              </span>
            </a>
          </div>
